...
public class SimpleDslFilterStreams {
	private static final Logger log = LoggerFactory.getLogger(SimpleDslFilterStreams.class);

	private final static String BOOTSTRAP_SERVERS = "52.193.238.153:9092";
	
	public static void startStreams(final String applicationId, final String sourceTopic, final String targetTopic) {
	...
	public static void main(String[] args) {
		...
		startStreams(applicationId, sourceTopic, targetTopic);
	}
}
